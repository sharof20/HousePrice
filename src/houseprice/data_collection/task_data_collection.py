...
# NOTE: Pytask will skip the webscraping part due to lengthy time it takes.
...
def task_webscraping(produces):
    url = "https://www.unegui.mn/l-hdlh/l-hdlh-zarna/oron-suuts-zarna/ulan-bator/"
    data = run_collection(url)
